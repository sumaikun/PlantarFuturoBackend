...
class ProjectInventoryExport implements FromCollection
{
    ...
    */
    ...
    {
        return ForestUnit::select('forest_units.id', 'functional_units.code', 'forest_units.common_name', 'forest_units.scientific_name', 'forest_units.family', 'forest_units.cap_cm', 'forest_units.total_heigth_m', 'forest_units.commercial_heigth_m', 'forest_units.condition', 'forest_units.health_status', 'forest_units.cup_diameter_m', 'forest_units.north_coord', 'forest_units.east_coord', 'forest_units.note')
